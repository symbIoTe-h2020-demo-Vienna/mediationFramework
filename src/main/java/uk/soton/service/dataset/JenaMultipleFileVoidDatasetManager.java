...
/**
 *
 * The Class JenaMultipleFileVoidDatasetManager extends the JenaVoidDatasetManager class using multiple RDF files parsed
 * with Jena API.
 *
...
public class JenaMultipleFileVoidDatasetManager extends JenaVoidDatasetManager {
    ...
    /**
     * The Class RDFFileFilter. FileFilter for RDF and OWL files.
     */
