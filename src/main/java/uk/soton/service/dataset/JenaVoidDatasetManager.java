...
/**
 *
 * The Class JenaVoidDatasetManager implements a DatasetManager using Jena as an RDF API and Void as dataset descriptor
 * vocabulary.
 *
...
public abstract class JenaVoidDatasetManager implements DatasetManager {
    ...
    public List<String> getDatasetsID() {
        ...
        ResIterator ri = m.listResourcesWithProperty(m.getProperty(RDF_TYPE), NodeFactory.createURI(VOID_DATASET));
