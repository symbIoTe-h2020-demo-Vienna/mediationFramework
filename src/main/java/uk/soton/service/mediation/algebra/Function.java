...
public interface Function {
    ...
    /**
     * The eval method takes as input an ordered list of NodeValue parameters and apply the function over them (ground
     * value)
     *
    ...
    /**
     * The copy method takes as input an ordered list of Expr instances and reconstruct the function with those
     * (function to run)
     *
     * @param args
