...
public class TransformationVisitor implements EDOALVisitor, RewritingRuleGenerator {
 ...
 /*@Override
    ...
    /**
     * The visit method visit the Transformation structure and generate the RewritingRule that implements the
     * Transformation.
     *
    ...
    /**
     * The reifyFD method scan the list of parameters of a FunctionalDependency and replaces every property found with a
     * variable that is bounded to an object whose predicate is the property itself. e.g. ?y = f(p) --> <s , p , ?v> +
     * ?y=f(?v)
     *
