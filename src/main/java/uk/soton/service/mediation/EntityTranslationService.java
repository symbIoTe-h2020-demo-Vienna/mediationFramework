...
/**
 * The Interface EntityTranslationService defines a service that translate a Basic Graph Pattern in accordance with a
 * given ontology alignment.
 *
...
public interface EntityTranslationService {
    ...
    /**
     * This method apply a simple transformation for a list of triples. No function application are devised nor complex
     * structures for lhs patterns. (i.e. the matching head is just one triple, not a list.)
     *
