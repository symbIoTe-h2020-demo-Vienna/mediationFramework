...
/**
 * The Interface Alignment defines the basic information contained in an ontology alignment based on RDF graph rewriting
 * rules.
 *
...
public interface Alignment {
     ...
     *
     * @param sourceOntologyURIs list of URIs of source ontologies managed by the alignment to set.
     */
     ...
     *
     * @param targetOntologyURIs list of URIs of target ontologies managed by the alignment to set.
     */
     ...
     *
     * @param targetDatasetURIs list of URIs of target datasets managed by the alignment to set.
     */
     ...
     *
     * @param t Triple to match against the LHS of all the patterns contained in the alignment.
